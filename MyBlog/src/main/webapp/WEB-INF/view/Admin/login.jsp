...
//    String projectUrl = request.getServletContext().getRealPath("/uploads");
//    System.out.println(projectUrl);
//    System.out.println(request.getContextPath().toString());
//    System.out.println("d:"+request.getSession().getServletContext().getRealPath("/resource/uploads"));
//
...
<div id="login">
    ...
    <p id="backtoblog"><a href="/">&larr; 返回到我的博客</a></p>
